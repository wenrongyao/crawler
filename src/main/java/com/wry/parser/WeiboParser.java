...
import com.wry.util.CompressUtil;
...
public class WeiboParser {
	...
	private String downloadFile(Map<String, String> linkMap, String ajaxUrl) {
		String end_id = "";
		try {
			BrowserHttpclient bs = new BrowserHttpclient(ajaxUrl);
	 ...
	 * @return
	 */
	private static String parseDiscussJson(Document doc, List<Discuss> discussList) {
		String url = null;
		try {
